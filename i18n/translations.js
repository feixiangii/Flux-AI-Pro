...
export const TRANSLATIONS = {
  ...
  zh: {
    ...
    video_model_seedance_pro_desc: "Seedance Pro 專業級影片生成模型，更好的提示詞遵循能力 (2-10秒)",
    video_model_seedance_desc: "Seedance 高品質影片生成模型，支援文字和圖片輸入 (2-10秒)",
    video_model_wan_desc: "Wan 影片生成模型，支援圖片輸入和音頻 (2-15秒，最高1080P)",
    video_model_veo_desc: "Google 的影片生成模型，僅支援文字輸入 (4-8秒)，需要 API Key",
  ...
  en: {
    ...
    video_model_seedance_pro_desc: "Professional-grade video generation model with better prompt adherence (2-10s)",
    video_model_seedance_desc: "High-quality video generation model, supports text and image input (2-10s)",
    video_model_wan_desc: "Wan video generation model, supports image input and audio (2-15s, up to 1080P)",
    video_model_veo_desc: "Google's video generation model, text-to-video only (4-8s), requires API Key",
    video_provider_pollinations: "Pollinations.ai",
  ...
  ja: {
    ...
    video_model_svd: "SVD",
    video_model_svd_xt: "SVD-XT",
    video_model_seedance_pro_desc: "プロフェッショナルグレードの動画生成モデル、より良いプロンプト追従能力 (2-10秒)",
    video_model_seedance_desc: "高品質の動画生成モデル、テキストと画像入力をサポート (2-10秒)",
    video_model_wan_desc: "Wan動画生成モデル、画像入力とオーディオをサポート (2-15秒、最大1080P)",
    video_model_veo_desc: "Googleの動画生成モデル、テキストから動画のみ (4-8秒)、API Keyが必要",
    video_provider_pollinations: "Pollinations.ai",
  ...
  ko: {
    ...
    video_model_veo_desc: "Google의 동영상 생성 모델, 텍스트에서 동영상만 (4-8초), API Key 필요",
    video_provider_pollinations: "Pollinations.ai",
  ...
  ar: {
    ...
    video_model_seedance_pro_desc: "نموذج إنشاء فيديو Seedance Pro احترافي، أفضل اتباع للمطالبات (2-10 ثانية)",
    video_model_seedance_desc: "نموذج إنشاء فيديو Seedance عالي الجودة، يدعم إدخال النص والصورة (2-10 ثانية)",
    video_model_wan_desc: "نموذج إنشاء فيديو Wan، يدعم إدخال الصورة والصوت (2-15 ثانية، حتى 1080P)",
    video_model_veo_desc: "نموذج إنشاء فيديو من Google، نص إلى فيديو فقط (4-8 ثانية)، يتطلب API Key",
