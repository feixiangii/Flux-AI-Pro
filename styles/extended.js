...
export const EXTENDED_STYLES = {
  // ====== 賽博朋克擴展 ======
  "cyberpunk-2077": {
    name: { zh: "賽博朋克 2077", en: "Cyberpunk 2077" },
  ...
  "cyberpunk-retro": {
    name: { zh: "復古賽博", en: "Retro Cyberpunk" },
  ...
  "cyberpunk-noir": {
    name: { zh: "賽博黑色", en: "Cyberpunk Noir" },
  ...
  "generative-art": {
    name: { zh: "生成藝術", en: "Generative Art" },
  ...
  "art-nouveau-2": {
    name: { zh: "新藝術 2", en: "Art Nouveau 2" },
  ...
  "light-academia": {
    name: { zh: "明亮學院", en: "Light Academia" },
  ...
  "kishimoto-masashi": {
    name: { zh: "岸本齊史", en: "Masashi Kishimoto" },
  ...
  "araki-hirohiko": {
    name: { zh: "荒木飛呂彥", en: "Hirohiko Araki" },
  ...
  "togashi-yoshihiro": {
    name: { zh: "富堅義博", en: "Yoshihiro Togashi" },
  ...
  "takahashi-rumiko": {
    name: { zh: "高橋留美子", en: "Rumiko Takahashi" },
  ...
  "gotouge-koyoharu": {
    name: { zh: "吾峠呼世晴", en: "Koyoharu Gotouge" },
  ...
  "fujiko-f-fujio": {
    name: { zh: "藤子·F·不二雄", en: "Fujiko F. Fujio" },
  ...
  "horikoshi-kohei": {
    name: { zh: "堀越耕平", en: "Kohei Horikoshi" },
...
export const EXTENDED_CATEGORIES = {
  'cyberpunk': { name: { zh: '賽博朋克', en: 'Cyberpunk' }, icon: '🌃', order: 14 },
  'dark-fantasy': { name: { zh: '黑暗奇幻', en: 'Dark Fantasy' }, icon: '🌑', order: 15 },
  'high-fantasy': { name: { zh: '高等奇幻', en: 'High Fantasy' }, icon: '🏰', order: 16 },
  'fairy-tale': { name: { zh: '童話', en: 'Fairy Tale' }, icon: '🧚', order: 17 },
  'mythology': { name: { zh: '神話', en: 'Mythology' }, icon: '⚡', order: 18 },
  'retro': { name: { zh: '復古', en: 'Retro' }, icon: '📼', order: 19 },
  'academic': { name: { zh: '學院風', en: 'Academic' }, icon: '📚', order: 20 },
  'royal': { name: { zh: '皇室風', en: 'Royal' }, icon: '👸', order: 21 },
  'eco': { name: { zh: '生態', en: 'Eco' }, icon: '☀️', order: 22 },
  'anime-genre': { name: { zh: '動漫類型', en: 'Anime Genre' }, icon: '📺', order: 23 },
  'manga-author': { name: { zh: '漫畫作者', en: 'Manga Author' }, icon: '✏️', order: 24 }
};